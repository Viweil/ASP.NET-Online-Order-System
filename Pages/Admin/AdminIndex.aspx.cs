...
public partial class Pages_Admin_AdminIndex : System.Web.UI.Page
{
    ...
    public void ST_check_Login()
    {
        ...
        {
            Response.Write("<script>alert('Sorry, you are not administrator.');location='AdminLogin.aspx'</script>");
            Response.End();
        }
    }
    ...
    {
        string strSql = "select OrderID,OrderDate,Round(TotalPrice,2)as TotalPrice from ProductOrder";
